# ETH/USDT 六书融合量化交易策略 v9.0.1 — 完整技术规格书
...
**初始资金**: $100,000 USDT
**策略版本**: v9.0.1 — 架构简化版 + 完整回测验证 (B1b + P24 + Anti-Squeeze + 衍生品数据集成)
**生产配置版本**: v5 (`STRATEGY_VERSION=v5`)

> **v9.0.1 回测验证更新** (2026-02-15):
> ⚠️ v5 生产配置完整 IS/OOS 回测发现: **IS PF=0.90 (低于 1.0)**。B1b 误杀 IS 盈利 neutral short, P24 过度截断 trend short 利润。OOS 因无 short 交易无法验证 v9 特性。新增 P33/P34/P35 紧急优化项。

> **v9.0 变更摘要** (2026-02-15):
...
| 版本 | 日期 | 核心变更 |
|------|------|---------|
| **v9.0.1** | **2026-02-15** | **v5 完整回测验证: IS PF=0.90 ⚠️, 发现 B1b 误杀盈利信号 + P24 截断利润, 新增 P33/P34/P35 紧急优化项** |
