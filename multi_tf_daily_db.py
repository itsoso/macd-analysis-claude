...
def _build_strategy_snapshot(config):
    ...
    snapshot = {
        ...
        'div_bottom_single_bonus': config.get('div_bottom_single_bonus'),
        'div_bottom_area_bonus': config.get('div_bottom_area_bonus'),
        'div_bottom_dif_bonus': config.get('div_bottom_dif_bonus'),
        'div_bottom_exhaust_bonus': config.get('div_bottom_exhaust_bonus'),
        'div_bottom_zero_ret_bonus': config.get('div_bottom_zero_ret_bonus'),
        'div_bottom_top_mult': config.get('div_bottom_top_mult'),
        'div_bottom_trend_mult': config.get('div_bottom_trend_mult'),
        ...
        'close_signal_margin': config.get('close_signal_margin'),
        ...
        'min_atr_pct_to_open': config.get('min_atr_pct_to_open'),
        ...
        'continuous_trail_start_pnl': config.get('continuous_trail_start_pnl'),
        'continuous_trail_max_pb': config.get('continuous_trail_max_pb'),
        'continuous_trail_min_pb': config.get('continuous_trail_min_pb'),
        'continuous_trail_max_pb_short': config.get('continuous_trail_max_pb_short'),
        # ATR 止损
        ...
        'dynamic_regime_lookback_bars': config.get('dynamic_regime_lookback_bars'),
        'dynamic_regime_vol_quantile': config.get('dynamic_regime_vol_quantile'),
        'dynamic_regime_trend_quantile': config.get('dynamic_regime_trend_quantile'),
        ...
        'use_soft_antisqueeze': config.get('use_soft_antisqueeze', False),
        'soft_antisqueeze_w_fz': config.get('soft_antisqueeze_w_fz'),
        'soft_antisqueeze_w_oi': config.get('soft_antisqueeze_w_oi'),
        'soft_antisqueeze_w_imb': config.get('soft_antisqueeze_w_imb'),
        'soft_antisqueeze_midpoint': config.get('soft_antisqueeze_midpoint'),
        'soft_antisqueeze_steepness': config.get('soft_antisqueeze_steepness'),
        'soft_antisqueeze_max_discount': config.get('soft_antisqueeze_max_discount'),
        ...
        'use_neutral_short_dynamic_budget': config.get('use_neutral_short_dynamic_budget', False),
        'neutral_short_low_quality_floor': config.get('neutral_short_low_quality_floor'),
        'neutral_short_crowding_floor': config.get('neutral_short_crowding_floor'),
        'neutral_short_quality_cov_thr': config.get('neutral_short_quality_cov_thr'),
        'neutral_short_quality_stale_thr': config.get('neutral_short_quality_stale_thr'),
        'neutral_short_crowding_funding_z': config.get('neutral_short_crowding_funding_z'),
        'neutral_short_crowding_oi_z': config.get('neutral_short_crowding_oi_z'),
        'neutral_short_crowding_taker_imb': config.get('neutral_short_crowding_taker_imb'),
        # P21: risk-per-trade
        'use_risk_per_trade': config.get('use_risk_per_trade', False),
        'risk_per_trade_pct': config.get('risk_per_trade_pct'),
        'risk_stop_mode': config.get('risk_stop_mode'),
        'risk_atr_mult_short': config.get('risk_atr_mult_short'),
        'risk_atr_mult_long': config.get('risk_atr_mult_long'),
        'risk_fixed_stop_short': config.get('risk_fixed_stop_short'),
        'risk_fixed_stop_long': config.get('risk_fixed_stop_long'),
        'risk_max_margin_pct': config.get('risk_max_margin_pct'),
        'risk_min_margin_pct': config.get('risk_min_margin_pct'),
        # v10.3 D1: 结构锚定 + ATR 包络止损
        'use_structure_anchor_sl': config.get('use_structure_anchor_sl', False),
        'structure_anchor_lookback': config.get('structure_anchor_lookback'),
        'structure_anchor_short_buffer_atr': config.get('structure_anchor_short_buffer_atr'),
        'structure_anchor_long_buffer_atr': config.get('structure_anchor_long_buffer_atr'),
        'structure_anchor_k_neutral': config.get('structure_anchor_k_neutral'),
        'structure_anchor_k_trend': config.get('structure_anchor_k_trend'),
        'structure_anchor_k_low_vol_trend': config.get('structure_anchor_k_low_vol_trend'),
        'structure_anchor_k_high_vol': config.get('structure_anchor_k_high_vol'),
        'structure_anchor_k_high_vol_choppy': config.get('structure_anchor_k_high_vol_choppy'),
        'structure_anchor_min_stop_short': config.get('structure_anchor_min_stop_short'),
        'structure_anchor_max_stop_short': config.get('structure_anchor_max_stop_short'),
        'structure_anchor_min_stop_long': config.get('structure_anchor_min_stop_long'),
        'structure_anchor_max_stop_long': config.get('structure_anchor_max_stop_long'),
        # 止损后冷却倍数
